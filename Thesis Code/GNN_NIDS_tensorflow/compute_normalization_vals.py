...
column_to_name= ['Flow ID','Source IP','Source Port','Destination IP','Destination Port','Protocol','Timestamp','Flow Duration',
                ...
                'Average Packet Size','Avg Fwd Segment Size','Avg Bwd Segment Size','Fwd Header Length,Fwd Avg Bytes/Bulk',
...
path = os.path.abspath(params[directory]["train"])
